...
import math, os, json
class Z3_SMT_SymBrk_ImplConstr_Solver: # name: z3_smt_symbrk_implconstr
    ...
    def create_smt_model(self):
        x, y, courier_distances = self.create_assignment_variables(), self.create_routing_variables(), self.create_distance_variables()
